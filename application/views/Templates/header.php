...
<head>
  ...
  <title>Agaram Accounting</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?php base_url();?>assets/img/favicon1.ico" rel="icon">
  <link href="<?php base_url();?>assets/img/favicon1.ico" rel="apple-touch-icon">
...
<header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="<?php base_url();?>assets/img/logo1.png" alt="">
        <!--<span>myStartUp</span>-->
      </a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#Our_team">Our Team</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Offshore Accounting Solutions Designed for CPA Firms</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Your Firm.  Your Processes.  Your Secure Data. </h2>
